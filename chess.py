...
- create all viable moves for figures
- unittest
- redo with Figure, Pawn(Figure), etc. classes
- GUI

- TURN STARTS HERE - """

import chess_functions as chess_f

print(chess_f.print_board(chess_f.board), "\n")

#selecting tile and figure

figures_list = tuple(tile for line in chess_f.figures for tile in line)
